...
'***********************************************
' 2/28/2017 - BLC - FindMatch() commented out
'                   Unused in Project
'                   Compile Error: Method or data member not found (.FindFirst)
'***********************************************
...
'***********************************************
' 2/28/2017 - BLC - TableNamesAndIndexes() commented out
'                   Unused in Project
'                   Compile Error: Method or data member not found (idx.Fields)
'***********************************************

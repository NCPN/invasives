dbMemo "SQL" ="SELECT t.*, q.Quadrat, q.IsSampled, q.NoExotics, 'IsSampled_Q' & q.Quadrat AS Co"
    "lNameIsSampled, 'NoExotics_Q' & q.Quadrat AS ColNameNoExotics\015\012FROM Transe"
    "ct AS t LEFT JOIN Quadrat AS q ON q.Transect_ID = t.Transect_ID;\015\012"
dbMemo "Connect" =""
